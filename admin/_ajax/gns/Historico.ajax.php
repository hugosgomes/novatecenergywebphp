        ...
        if($Read->getResult()){
            ...
            foreach ($Read->getResult() as $dataOT){
                ...
                $jSON['historicoOs'] .= "<div class='box box100' style='padding-bottom: 0px;'>
                                      <li style='padding-bottom: 5px;'><h3><b>OT: &ensp;{$dataOT['NumOT']}</b></h3></li>
                                      </div>";
                        ...
                        if ($Read->getResult()):
                            ...
                            foreach ($Read->getResult() as $Oss):
                                ...
                                if($Read->getResult()){
                                    foreach ($Read->getResult() as $img) {
                                        ...
                                        switch ($img['Tipo']) {
                                            case '1':
                                                $imgs .= "<div style='width:15%;display:inline-block'><a href='http://192.168.0.101:83/novatec/uploads/{$img['Foto']}' rel='shadowbox'>
                                            ...
                                            case '2':
                                                $imgs2 .= "
                                            <div style='width:15%;display:inline-block'><a href='http://192.168.0.101:83/novatec/uploads/{$img['Foto']}' rel='shadowbox'>
                           ...
                           $Read->FullRead("SELECT [60_OS].OT, CONVERT(VARCHAR(10), [60_OS].DataAgendamento, 103) AS DataAgendamento,
                            ...
                            $jSON['dadosCli'] .= "<div class='box box100' style='padding-bottom: 0px;'>
                                                    ...
                                                    <div class='box box50' style='padding-bottom: 0px;'>
                                                        <li style='padding-bottom: 5px;font-size: 12px;'>Telefone: {$Read->getResult()[0]['Telefone1']}</li>
                                                        <li style='padding-bottom: 5px;font-size: 12px;'>Telefone: {$Read->getResult()[0]['Telefone2']}</li>
                                                        <li style='padding-bottom: 5px;font-size: 12px;'>Telefone Zeus: {$Read->getResult()[0]['TelefoneZeus']}</li>
                                                        <li style='padding-bottom: 5px;font-size: 12px;'>Visitas no Ano: {$count_visit}</li>
                                                    </div>

                                                    <div class='box box50' style='padding-bottom: 0px;text-align: right;'>
                                                        <li style='padding-bottom: 5px;font-size: 12px;'>Endereço: {$Read->getResult()[0]['Endereco']}</li>
                                                        <li style='padding-bottom: 5px;font-size: 12px;'>Bairro: {$Read->getResult()[0]['Bairro']}</li>
                                                        <li style='padding-bottom: 5px;font-size: 12px;'>CEP: {$Read->getResult()[0]['Cep']}</li>
                                                    </div>

                                                    <div class='box box50' style='padding-bottom: 0px;'>
                                                        <li style='padding-bottom: 5px;font-size: 12px;'>Zona: {$Read->getResult()[0]['Zona']}</li>
                                                    </div>

                                                    <div class='box box50' style='padding-bottom: 0px;text-align: right;'>
                                                        <li style='padding-bottom: 5px;font-size: 12px;'>SubZona: {$Read->getResult()[0]['SubZona']}</li>
                                                    </div>
                                                    
                                                    <div class='box box50' style='padding-bottom: 0px;'>
                                                        <li style='padding-bottom: 5px;font-size: 12px;'>CPF/CNPJ: {$Read->getResult()[0]['CPFCNPJ']}</li>
                                                    </div>

                                                    <div class='box box50' style='padding-bottom: 0px;text-align: right;'>
                                                        <li style='padding-bottom: 5px;font-size: 12px;'>E-mail GNS: {$Read->getResult()[0]['EmailGns']}</li>
                                                    </div>";
