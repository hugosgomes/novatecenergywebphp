...
<label class="label box box50">
    ...
    <input type="text" name="t_p_inicial" id="t_p_inicial" class="t_p_inicial" onkeypress='return SomenteNumero(this,event)' placeholder="Inicial:" />
</label>
<label class="label box box50">
    <span class="legend"><b>Pressão Final:</b></span>
    <input type="text" name="t_p_Final" id="t_p_Final" class="t_p_Final" onkeypress='return SomenteNumero(this,event)' placeholder="Final:" />
</label>
<label class="label box box100">
    <span class="legend"><b>Tempo do teste:</b></span>
    <input type="text" name="t_tempo_teste" id="t_tempo_teste" class="t_tempo_teste" onkeypress='return SomenteNumero(this,event)'  placeholder="Tempo:" />
</label>
<label class="label box box100">
