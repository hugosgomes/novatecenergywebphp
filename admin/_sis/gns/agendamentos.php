...
<div class="dashboard_content custom_app">
    <article class="box box100">   
        ...
        <div class="box_content">
            <a title="OS Sem Endereço" href="dashboard.php?wc=gns/osEndereco" class="btn btn_green flt_left icon-plus">OS sem Endereço</a>
            <a title="OS Sem Endereço" href="dashboard.php?wc=gns/relatorioDiario" class="btn btn_green flt_left icon-plus">Relatório Exp. Diário</a>
            <a title="OS Sem Endereço" href="dashboard.php?wc=gns/clienteOT" class="btn btn_green flt_left icon-plus">Clientes Sem OT / OS</a>
        </div>
    </article>
    <article class="box box70">
        <header>
          <?php
            ...
            echo "<a title='Recarregar Comentários' href='dashboard.php?wc=gns/agendamentos&day={$Hoje}' class='btn btn_green'>Agendamentos HOJE</a>";
            echo "<a title='Recarregar Comentários' href='dashboard.php?wc=gns/agendamentos&day={$Amanha}' class='btn btn_green m_left'>Agendamentos AMANHÃ</a>";
            echo "<a title='Recarregar Comentários' href='dashboard.php?wc=gns/agendamentos&day={$Hoje}&s=1' class='btn btn_green m_left'>Agendamentos da SEMANA</a>";
          ?>
        </header>
        <div class="box_content">
